    ...
    <div class="gallery-section">
        <div class="wrapper">
            <div class="gallery-btns button-group filterizr-filter">
                <button class="btn-1 gal active gal-big"><a href="<?php bloginfo("url")?>/gallery">Annick</a></button>
                <button class="btn-1 gal gal-big"><a href="<?php bloginfo("url")?>/galleryartsenic">Artsenic</a></button>
            </div>
